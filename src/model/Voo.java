...
public class Voo {
	...
	public Voo(int id_voo, Aeronave aeronave, Aeroporto aeroportoPartida, LocalDate dataPartida, LocalTime horaPartida,
			Aeroporto aeroportoChegada, LocalDate dataChegada, LocalTime horaChegada, int lotacao,
			double pesoCargaEmbarcada, double precoViagem, int tipoAeronave) {
		this.id_voo = id_voo;
	...
	public void consultarLotacao() {

		System.out.println("Vagas disponíveis para o Voo: " + lotacao);
		System.out.println("-------------------------------------------------");
	}
	
	public void consultarCarga(double carga, double cargaMaxima) {

		Double valor = cargaMaxima - carga;

		System.out.println("Carga disponível nesse voo: " + valor);
		System.out.println("-------------------------------------------------");
	}
}
